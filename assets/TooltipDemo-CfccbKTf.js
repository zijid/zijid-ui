import{I as u,D as m,A as l,H as o,R as n,P as e,e as s,Z as d,K as r,g as i,G as p,_ as c}from"./index-BxmJ7YZy.js";import{A as Z}from"./ApiTable-Dwr88J6i.js";const f={class:"demo-page"},g={class:"demo-section"},T={class:"preview-box"},v={class:"demo-section"},x={class:"preview-box",style:{display:"flex","flex-wrap":"wrap","justify-content":"center","align-items":"flex-start",gap:"48px 64px",padding:"48px 24px"}},B={class:"demo-section"},_={class:"preview-box"},y={class:"demo-section"},w={class:"preview-box"},b={class:"demo-section"},C={class:"preview-box",style:{display:"flex",gap:"24px","justify-content":"center"}},k={class:"demo-section"},z={class:"preview-box",style:{display:"flex",gap:"16px","justify-content":"center"}},A={class:"demo-section"},j=`<ZTooltip content="这是一个提示信息">
  <ZButton>鼠标移入查看</ZButton>
</ZTooltip>`,D=`<ZTooltip content="顶部提示" placement="top">
...
</ZTooltip>`,I=`<ZTooltip content="点击触发的提示，点击外部区域关闭" trigger="click">
  <ZButton>点击我</ZButton>
</ZTooltip>`,N=`<ZTooltip content="这是一段较长的提示信息，用于展示 Tooltip 在多行文本情况下的显示效果。">
  <ZButton>长提示</ZButton>
</ZTooltip>`,P=`<ZTooltip content="窄宽度提示，文字会自动换行显示" :max-width="120">
  <ZButton>窄提示 (120px)</ZButton>
</ZTooltip>

<ZTooltip content="更宽的提示框可以容纳更多文字内容在一行显示" :max-width="400">
  <ZButton>宽提示 (400px)</ZButton>
</ZTooltip>`,V=`<ZTooltip content="保存当前修改的内容" placement="top">
