import{d as I,c as f,a as t,b as a,w as o,u as s,z as m,Z as c,F as $,r as h,i,o as y,t as n,e as U,_ as z,v as r}from"./index-DytvuLaL.js";import{A as N}from"./ApiTable-YVgjCaIY.js";const P={class:"demo-page"},q={class:"demo-section"},E={class:"preview-box",style:{"flex-direction":"column","align-items":"stretch"}},F={class:"demo-section"},j={class:"preview-box",style:{"flex-direction":"column","align-items":"stretch"}},D={class:"demo-section"},L={class:"preview-box",style:{"flex-direction":"column","align-items":"stretch"}},S={style:{"margin-bottom":"16px",display:"flex",gap:"8px"}},G={class:"demo-section"},H={class:"preview-box",style:{"flex-direction":"column","align-items":"stretch"}},J={class:"demo-section"},M=`<ZTabs v-model="activeKey" :items="items">
  <p>当前内容</p>
</ZTabs>
...
//# sourceMappingURL=TabsView-8Qp6J2cn.js.map
