import{d as u,c as m,a as l,b as o,w as n,u as e,L as s,Z as d,o as r,_ as i,e as p,k as c}from"./index-WzoAP_LW.js";import{A as Z}from"./ApiTable-BL1aRZnM.js";const f={class:"demo-page"},g={class:"demo-section"},T={class:"preview-box"},v={class:"demo-section"},x={class:"preview-box",style:{display:"flex","flex-wrap":"wrap","justify-content":"center","align-items":"flex-start",gap:"48px 64px",padding:"48px 24px"}},B={class:"demo-section"},_={class:"preview-box"},y={class:"demo-section"},w={class:"preview-box"},b={class:"demo-section"},C={class:"preview-box",style:{display:"flex",gap:"24px","justify-content":"center"}},k={class:"demo-section"},z={class:"preview-box",style:{display:"flex",gap:"16px","justify-content":"center"}},j={class:"demo-section"},A=`<ZTooltip content="这是一个提示信息">
...
//# sourceMappingURL=TooltipDemo-2cqsGt2I.js.map
