import{d as u,c,a as o,b as t,u as s,Z as n,o as m}from"./index-WzoAP_LW.js";import{A as g}from"./ApiTable-BL1aRZnM.js";const p={class:"demo-page"},h={class:"demo-section"},f={class:"demo-section"},v={class:"demo-section"},b={class:"demo-section"},y={class:"demo-section"},j={class:"demo-section"},C={class:"demo-section"},x={class:"demo-section"},k={class:"demo-section"},B={class:"demo-section"},w={class:"demo-section"},L={class:"demo-section"},S={class:"demo-section"},Z={class:"demo-section"},H={class:"demo-section"},N={class:"demo-section"},q={class:"demo-section"},z={class:"demo-section"},V={class:"demo-section"},_={class:"demo-section"},A={class:"demo-section"},l=`function greet(name) {
  return \`Hello, \${name}!\`;
}
...
//# sourceMappingURL=CodeBlockDemo-0YTPwb4u.js.map
