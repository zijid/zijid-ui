import{d as w,c as _,a as s,b as t,w as i,u as o,I as d,Z as m,o as g,_ as l,e as a}from"./index-DytvuLaL.js";import{A as B}from"./ApiTable-YVgjCaIY.js";const D={class:"demo-page"},y={class:"demo-section"},x={class:"preview-box"},C={class:"demo-section"},I={class:"preview-box",style:{"justify-content":"center",gap:"24px"}},k={class:"demo-section"},S={class:"preview-box"},z={class:"demo-section"},A={class:"preview-box"},N={class:"demo-section"},V=`<ZDropdown :items="items" @select="onSelect">
...
<\/script>`,E=`<ZDropdown :items="items" placement="bottom-start">
  <ZButton>左下</ZButton>
</ZDropdown>
...
<ZDropdown :items="items" placement="bottom-end">
  <ZButton>右下</ZButton>
</ZDropdown>`,P=`<ZDropdown :items="items" trigger="hover">
